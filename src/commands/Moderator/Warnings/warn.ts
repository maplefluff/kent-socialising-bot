...
@ApplyOptions<CommandOptions>({
	...
	requiredUserPermissions: [
		PermissionFlagsBits.ModerateMembers | PermissionFlagsBits.Administrator,
	],
})
export class WarnCommand extends Command {
	...
	public async chatInputRun(interaction: Command.ChatInputCommandInteraction) {
		...
		if (!member)
			return interaction.reply("Please provide a valid member to warn");
	...
	private handleWarning(
		...
		const modalActionRow =
			new ActionRowBuilder<TextInputBuilder>().addComponents(reasonTextInput);
